...
bin\phpsdk_setshell.bat %CRT% %ARCH% && bin\phpsdk_setvars.bat && bin\phpsdk_dumpenv.bat && bin\phpsdk_buildtree.bat phpdev && cd php-%PHP_VER% && copy /Y "C:\Program Files (x86)\Windows Kits\10\Lib\10.0.19041.0\um\%ARCH%\ImageHlp.Lib" ..\deps\lib\ && ..\..\..\..\bin\phpsdk_deps -u --no-backup && if EXIST config.nice.bat (
