...
C.WriteLine("/* This file automatically generated from src/win32/build/confutils.js */");
C.WriteLine("MODE_PHPIZE=false;");
C.Write(file_get_contents("src/win32/build/confutils.js"));

// Pull in code from sapi and extensions
modules = file_get_contents("src/win32/build/config.w32");
...
C.WriteBlankLines(1);
C.Write(file_get_contents("src/win32/build/configure.tail"));
